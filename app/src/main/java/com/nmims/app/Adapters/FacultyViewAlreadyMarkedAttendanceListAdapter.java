...
public class FacultyViewAlreadyMarkedAttendanceListAdapter extends ArrayAdapter<AttendanceStudentDataModel> {
    ...
    public FacultyViewAlreadyMarkedAttendanceListAdapter(ArrayList<AttendanceStudentDataModel> data, Context context, NoSearch noSearch) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        else
        {
            ...
            viewHolder.student_absent_present.setTextColor(getContext().getResources().getColor(R.color.colorPrimary));
        }
